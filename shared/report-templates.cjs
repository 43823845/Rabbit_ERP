...
const REPORT_TEMPLATES = [
  ...
  // ===== 所有者权益变动表 =====
  { report_type:'equity_change', row_no:1, name:'一、上年年末余额', is_header:1, bold:1, display_order:1 },
  { report_type:'equity_change', row_no:2, name:'实收资本（或股本）', bold:0, subject_codes:'4001', display_order:2 },
  { report_type:'equity_change', row_no:3, name:'资本公积', bold:0, subject_codes:'4002', display_order:3 },
  { report_type:'equity_change', row_no:4, name:'盈余公积', bold:0, subject_codes:'4101', display_order:4 },
  { report_type:'equity_change', row_no:5, name:'未分配利润', bold:0, subject_codes:'4104', display_order:5 },
  { report_type:'equity_change', row_no:6, name:'上年年末余额合计', is_total:1, bold:1, display_order:6 },
  { report_type:'equity_change', row_no:7, name:'二、本年年初余额', is_header:1, bold:1, display_order:7 },
  { report_type:'equity_change', row_no:8, name:'实收资本（或股本）', bold:0, display_order:8 },
  { report_type:'equity_change', row_no:9, name:'资本公积', bold:0, display_order:9 },
  { report_type:'equity_change', row_no:10, name:'盈余公积', bold:0, display_order:10 },
  { report_type:'equity_change', row_no:11, name:'未分配利润', bold:0, display_order:11 },
  { report_type:'equity_change', row_no:12, name:'年初余额合计', is_total:1, bold:1, display_order:12 },
  { report_type:'equity_change', row_no:13, name:'三、本年增减变动金额', is_header:1, bold:1, display_order:13 },
  { report_type:'equity_change', row_no:14, name:'（一）净利润', bold:0, display_order:14 },
  { report_type:'equity_change', row_no:15, name:'（二）其他综合收益', bold:0, display_order:15 },
  { report_type:'equity_change', row_no:16, name:'（三）利润分配', bold:0, display_order:16 },
  { report_type:'equity_change', row_no:17, name:'1.提取盈余公积', indent_level:1, display_order:17 },
  { report_type:'equity_change', row_no:18, name:'2.对所有者（或股东）的分配', indent_level:1, display_order:18 },
  { report_type:'equity_change', row_no:19, name:'（四）所有者权益内部结转', bold:0, display_order:19 },
  { report_type:'equity_change', row_no:20, name:'本年增减变动合计', is_total:1, bold:1, display_order:20 },
  { report_type:'equity_change', row_no:21, name:'四、本年年末余额', is_header:1, bold:1, display_order:21 },
  { report_type:'equity_change', row_no:22, name:'实收资本（或股本）', bold:0, display_order:22 },
  { report_type:'equity_change', row_no:23, name:'资本公积', bold:0, display_order:23 },
  { report_type:'equity_change', row_no:24, name:'盈余公积', bold:0, display_order:24 },
  { report_type:'equity_change', row_no:25, name:'未分配利润', bold:0, display_order:25 },
  { report_type:'equity_change', row_no:26, name:'年末余额合计', is_total:1, bold:1, display_order:26 },
];
