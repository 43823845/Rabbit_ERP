...
const { applyLedgerMethods } = require('./ledgers.cjs');
const { applyStatementMethods } = require('./statements.cjs');
...
applyLedgerMethods(FinanceDatabase);
applyStatementMethods(FinanceDatabase);
